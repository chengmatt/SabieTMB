# Purpose: To bridge sabieRTMB v3 to a single region model
...
data$ObsSrvIdx_SE[1,colnames(data$ObsFishIdx_SE) %in% rownames(tem_dat$obssrv7),2] <- as.numeric(strsplit(tem_admb_dat[163], split = " ")[[1]])
