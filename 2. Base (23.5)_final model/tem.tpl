...
// ########################################################################################################
  init_bounded_vector  log_rec_dev(styr-nages+2,endyr_rec_est,-10,10,ph_recdev);  // Recruitment deviations from before the asssessment starts to present
...
//###########################################################################################################
 ...
 // ########################################################################################################
  ...
  init_bounded_vector   log_F_devs_fish3(styr+3,endyr,-5,5,ph_Fdev);  // Annual fishing mortality deviations
 ...
 if(bias_ramp==1)
  {
     ...
     {
      b(y)=bmax*(1-((y-b_yr_end)/(endyr_rec_est-b_yr_end)));
     }
    }
 if(bias_ramp==0)
  {
